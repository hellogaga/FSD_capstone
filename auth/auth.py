...
if 'IF_HEROKU' in os.environ:
    ...
    ALGORITHMS = [os.environ['ALGORITHMS']]
    API_AUDIENCE = os.environ['APIAUDIENCE']

# the following for backup
...
def verify_decode_jwt(token):
    '''
    decode the jwt after authentication
    '''
    ...
    # If key do not exist, raise an error
    raise AuthError({
        'code': 'invalid_header',
